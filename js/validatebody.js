...
//================{Проверяет расширение файла '.jpg', '.png', '.gif','.bmp'}====================
 	//====================={File1}========================
      	...
      	if (!(file1).hasExtension(['.jpg', '.png', '.gif','.bmp'])) 
      		{
 	...
 	//====================={File2}========================
      	...
      	if (!(file2).hasExtension(['.jpg', '.png', '.gif','.bmp'])) 
      		{
 	...
 	//====================={File3}========================
      	...
      	if (!(file3).hasExtension(['.jpg', '.png', '.gif','.bmp'])) 
      		{
 	...
 	//====================={File4}========================
      	...
      	if (!(file4).hasExtension(['.jpg', '.png', '.gif','.bmp'])) 
      		{
 	...
 	//====================={File5}========================
      	...
      	if (!(file5).hasExtension(['.jpg', '.png', '.gif','.bmp'])) 
      		{
 	...
 	//====================={File6}========================
      	...
      	if (!(file6).hasExtension(['.jpg', '.png', '.gif','.bmp'])) 
      		{
 	...
 	//====================={File7}========================
      	...
      	if (!(file7).hasExtension(['.jpg', '.png', '.gif','.bmp'])) 
      		{
 	...
 	//====================={File8}========================
      	...
      	if (!(file8).hasExtension(['.jpg', '.png', '.gif','.bmp'])) 
      		{
